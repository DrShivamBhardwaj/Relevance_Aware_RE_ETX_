...
def main():
    ...
    for corr in CORRELATIONS:
        for method in METHODS:
            ...
            print(f"corr={corr:.1f} method={method:8s} RMSE={statistics.fmean(r['rmse_c'] for r in group):.3f}C repJS={statistics.fmean(r['representation_js'] for r in group):.4f}")
    numeric = [
        ...
        'energy_j','min_residual_energy_j','max_relay_energy_j','participation_jain','representation_js'
    ]
    agg=[]
    for corr in CORRELATIONS:
        for method in METHODS:
    ...
    manifest={
        ...
        'gateway_motes':[10,26,48,38], 'methods':METHODS, 'seeds':SEEDS, 'correlations':CORRELATIONS,
